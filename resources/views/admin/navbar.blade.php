    ...
    <nav class="relative flex w-full flex-nowrap items-center justify-between bg-[var(--main1)] xl:px-44 lg:px-24 md:px-12 px-4 py-2 text-black shadow-dark-mild hover:text-neutral-700 focus:text-neutral-700 lg:flex-wrap lg:justify-start lg:py-4"
        data-twe-navbar-ref>
        <div class="flex w-full flex-wrap items-center justify-between">
            <div class="ms-2">
                <a class="text-xl text-black font-bold" href="#">Ora Et Labora Admin</a>
            </div>
            ...
            <div class="!visible mt-2 hidden basis-[100%] items-center lg:mt-0 lg:!flex lg:basis-auto"
                ...
                <ul class="list-style-none me-auto flex flex-col ps-0 lg:mt-1 lg:flex-row" data-twe-navbar-nav-ref>
                    <li class="my-2 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                        <a class="text-black lg:px-2" aria-current="page" href="{{ route('admin.homepage.index') }}"
                            data-twe-nav-link-ref>Homepage</a>
                    </li>
                    <li class="my-2 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                        <a class="text-black lg:px-2" aria-current="page" href="{{ route('admin.donation.index') }}"
                            data-twe-nav-link-ref>Donasi</a>
                    </li>
                    <li class="my-2 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                        <a class="text-black lg:px-2" aria-current="page" href="{{ route('admin.event.index') }}"
                            ...
                            <ul class="absolute z-[1000] float-left m-0 hidden min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg data-[twe-dropdown-show]:block"
                                ...
                                <li>
                                    <a class="block w-full whitespace-nowrap bg-white px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-zinc-200/60 focus:bg-zinc-200/60 focus:outline-none active:bg-zinc-200/60 active:no-underline"
                                        href="{{ route('admin.people.index') }}" data-twe-dropdown-item-ref>Jumlah Isi
                                        Panti Asuhan</a>
                                </li>
                                <li>
                                    <a class="block w-full whitespace-nowrap bg-white px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-zinc-200/60 focus:bg-zinc-200/60 focus:outline-none active:bg-zinc-200/60 active:no-underline"
                                        href="{{ route('admin.needs.index') }}" data-twe-dropdown-item-ref>Kebutuhan
                                        Panti Asuhan</a>
                                </li>
                            </ul>
                        </div>
